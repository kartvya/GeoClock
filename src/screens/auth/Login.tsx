...
import {useLazyGetUserProfileDetailsQuery} from '../../services/apis/user/userApi';
...
const Login = () => {
  ...
  const [getUserInfo] = useLazyGetUserProfileDetailsQuery();
  ...
  return (
    <ScreenWrapper
      ...
      <KeyboardAwareScrollView
        ...
        <CustomText text={'To GeoClock'} fontSize={RFValue(24)} />
        <CustomText
